...
local DistanceTags = {
  ...
  IntersectionRoundaboutFeederYield = {name = 'intersection: roundabout feeder yielding'},
  IntersectionFeederMandatoryStop = {name = 'intersection: feeder mandatory stop'},
  IntersectionRoundaboutExitBlocked = {name = 'intersection: roundabout exit blocked'},
